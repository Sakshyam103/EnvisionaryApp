...
const ViewResolvedPredictions = ({ data }) => {
    ...
    const fieldsToDisplay = ['predictionContent', 'predictionMadeDate', 'predictionEndDate', 'resolution'];
...
export default ViewResolvedPredictions;
