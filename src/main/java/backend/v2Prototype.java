...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
// v2Prototype - Written by Brandon LaPointe
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
...
public class v2Prototype {
    ...
    public static void login() {
        ...
        while (!isValidUser) {
            ...
            password = scan.next();
            isValidUser = UserInitializer.login(userID, password);
        }
        userMenu();
    }
    ...
    public static void createNewAccount() {
        ...
        while (!validUserID && !validPassword && !validEmail) {
            ...
            while (!validUserID) {
                ...
                validUserID = UserInitializer.isUserIdValid(userID);
            }
            while (!validPassword) {
            ...
            while (!validEmail) {
                ...
                validEmail = UserInitializer.isEmailValid(email);
                if (!validEmail) {
                    System.out.println("ERROR - Email not valid.");
                }
            }
        }
        UserInitializer.createNewAccount(userID, password, email);
                ...
                if (input >= 1 && input <= 10) {
                    ...
                    switch (userMenuSelection) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            CustomPredictionInitializer.printAllCustomPredictions(userID);
                            CelestialBodyPredictionInitializer.printAllUserCelestialBodyPredictions(userID);
                            FootballMatchPredictionInitializer.printAllFootballMatchPredictions(userID);
                            userMenuSelection = 0;
                            break;
                        case 5:
                            ResolvedPredictionInitializer.printAllResolvedPredictions(userID);
                            userMenuSelection = 0;
                            break;
                        case 6:
                            NotificationUpdater.loadAndDisplayUserNotifications(userID);
                            userMenuSelection = 0;
                            break;
                        case 7:
                            NotificationUpdater.removeUserNotification(userID);
                            userMenuSelection = 0;
                            break;
                        case 8:
                            NotificationUpdater.removeAllUserNotifications(userID);
                            userMenuSelection = 0;
                            break;
                        case 9:
                            statisticsMenu();
            ...
            try {
                ...
                if (input >= 1 && input <= 6) {
                    ...
                    switch (customPredictionMenuSelection) {
                        case 1:
                            CustomPredictionInitializer.createNewCustomPrediction(userID);
                            customPredictionMenuSelection = 0;
                            break;
                        case 2:
                            CustomPredictionInitializer.removeCustomPrediction(userID);
                            customPredictionMenuSelection = 0;
                            break;
                        case 3:
                            CustomPredictionInitializer.resolveCustomPrediction(userID);
                            customPredictionMenuSelection = 0;
                            break;
                        case 4:
                            CustomPredictionInitializer.printAllCustomPredictions(userID);
                            ...
                            break;
                        case 5:
                            ResolvedPredictionInitializer.printResolvedCustomPredictions(userID);
                            customPredictionMenuSelection = 0;
                            break;
                        case 6:
                ...
                if (input >= 1 && input <= 6) {
                    ...
                    switch (celestialBodyPredictionMenuSelection) {
                        case 1:
                            ...
                            break;
                        case 2:
                            CelestialBodyPredictionInitializer.createNewCelestialBodyPrediction(userID);
                            celestialBodyPredictionMenuSelection = 0;
                            break;
                        case 3:
                            CelestialBodyPredictionInitializer.removeCelestialBodyPrediction(userID);
                            celestialBodyPredictionMenuSelection = 0;
                            break;
                        case 4:
                            CelestialBodyPredictionInitializer.printAllUserCelestialBodyPredictions(userID);
                            ...
                            break;
                        case 5:
                            ResolvedPredictionInitializer.printResolvedSciencePredictions(userID);
                            celestialBodyPredictionMenuSelection = 0;
                            break;
                        case 6:
                            System.out.println("Returning back to main menu...");
                ...
                if (input >= 1 && input <= 9) {
                    ...
                    switch (footballPredictionMenuSelection) {
                        case 1:
                            ...
                            break;
                        case 2:
                            FootballMatchPredictionInitializer.createNewFootballMatchTomorrowPrediction(userID);        // TEST USING YESTERDAY'S MATCHES
                            footballPredictionMenuSelection = 0;
                            break;
                        case 3:
                            FootballMatchPredictionInitializer.createNewFootballMatchUpcomingWeek1Prediction(userID);
                            footballPredictionMenuSelection = 0;
                            break;
                        case 4:
                            FootballMatchPredictionInitializer.createNewFootballMatchUpcomingWeek2Prediction(userID);
                            footballPredictionMenuSelection = 0;
                            break;
                        case 5:
                            FootballMatchPredictionInitializer.createNewFootballMatchUpcomingWeek3Prediction(userID);
                            footballPredictionMenuSelection = 0;
                            break;
                        case 6:
                            FootballMatchPredictionInitializer.removeFootballMatchPrediction(userID);
                            footballPredictionMenuSelection = 0;
                            break;
                        case 7:
                            FootballMatchPredictionInitializer.printAllFootballMatchPredictions(userID);
                            ...
                            break;
                        case 8:
                            ResolvedPredictionInitializer.printResolvedFootballMatchPredictions(userID);
                            footballPredictionMenuSelection = 0;
                            break;
                        case 9:
                            System.out.println("Returning back to main menu...");
            ...
            try {
                ...
                if (input >= 1 && input <= 7) {
                    ...
                    switch (footballMatchMenuSelection) {
                        case 1:
                            FootballMatchUpdater.readAndDisplayYesterdayMatchesFile();
                            footballMatchMenuSelection = 0;
                            break;
                        case 2:
                            FootballMatchUpdater.readAndDisplayTodayMatchesFile();
                            footballMatchMenuSelection = 0;
                            break;
                        case 3:
                            FootballMatchUpdater.readAndDisplayTomorrowMatchesFile();
                            footballMatchMenuSelection = 0;
                            break;
                        case 4:
                            FootballMatchUpdater.readAndDisplayUpcomingWeek1MatchesFile();
                            footballMatchMenuSelection = 0;
                            break;
                        case 5:
                            FootballMatchUpdater.readAndDisplayUpcomingWeek2MatchesFile();
                            footballMatchMenuSelection = 0;
                            break;
                        case 6:
                            FootballMatchUpdater.readAndDisplayUpcomingWeek3MatchesFile();
                            footballMatchMenuSelection = 0;
                            break;
                        case 7:
            ...
            try {
                ...
                if (input >= 1 && input <= 5) {
                    ...
                    switch (statisticsMenuSelection) {
                        case 1:
                            UserDescriptiveStatisticsUpdater.loadAndDisplayUserDescriptiveStatistics(userID);
                            statisticsMenuSelection = 0;
                            break;
                        case 2:
                            UserInferentialStatisticsUpdater.loadAndDisplayUserInferentialStatistics(userID);
                            statisticsMenuSelection = 0;
                            break;
                        case 3:
